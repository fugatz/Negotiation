...
6. Build a curated recommendation slate.
7. Simulate client shortlist behavior.
8. Simulate talent response and negotiation.
9. Resolve booking, no-booking, repricing, or cancellation.
10. Update historical outcomes.
11. Repeat across many rounds.
12. Evaluate market-level metrics.
```
